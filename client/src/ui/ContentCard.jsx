        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            ...
            <button 
              ...
              className="text-gray-400 hover:text-red-400 transition-colors p-1 -mr-1 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          {url && (
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-flex items-center gap-1 text-emerald-400 text-sm hover:underline mt-1"
            >
